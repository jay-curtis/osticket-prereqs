...
<p>
With most of the osTicket installation files downloaded, I started the installation of osTicket v.1.15.8 from its zip file and uploaded the automated "upload" folder into the "wwwroot" folder ("Windows C:" > "inetpub" > "wwwroot"). I then renamed the "upload" file to "osTicket." 
</p>
<br />
<br /># osticket-prereqs
